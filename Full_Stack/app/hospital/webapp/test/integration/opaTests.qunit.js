...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "hm/hospital/test/integration/FirstJourney",
    "hm/hospital/test/integration/hospitalListJourney",
    "hm/hospital/test/integration/hospitalObjectPageJourney",
    "hm/hospital/test/integration/departmentObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
