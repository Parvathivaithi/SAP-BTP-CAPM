...
const tokenStore = {}
const xsuaaCreds = xsuaaSrv.credentials
const oa2 =
  xsuaaCreds['credential-type'] === 'x509'
    ? {
        client: xsuaaCreds.clientid,
        endpoint: xsuaaCreds.certurl,
        mTLS: { cert: xsuaaCreds.certificate, key: xsuaaCreds.key }
      }
    : {
        client: xsuaaCreds.clientid,
        secret: xsuaaCreds.clientsecret,
        endpoint: xsuaaCreds.url
      }
