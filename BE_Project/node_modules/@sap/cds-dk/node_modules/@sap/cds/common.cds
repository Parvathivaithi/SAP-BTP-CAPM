...
annotate sap.common.Currencies :code with @Common.Text:name;
annotate sap.common.Countries  :code with @Common.Text:name;
annotate sap.common.Languages  :code with @Common.Text:name;
