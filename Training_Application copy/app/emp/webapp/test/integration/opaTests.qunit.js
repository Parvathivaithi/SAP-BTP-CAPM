...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "ea/emp/test/integration/FirstJourney",
    "ea/emp/test/integration/employeeListJourney",
    "ea/emp/test/integration/employeeObjectPageJourney",
    "ea/emp/test/integration/EnrollmentsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
